...
# Config data
WANT_TOKEN = "0xaF4dE8E872131AE328Ce21D909C74705d3Aaf452"
...
def main():
    ...
    # add strat to vault
    vault.addStrategy(strategy, 9980, 0, 2 ** 256 - 1, 1000, {"from": dev})
    # Set deposit limit to 1008 1INCH tokens,Approx 50K
    vault.setDepositLimit(2 ** 256 - 1, {"from": dev})
    # Set keeper
